  ...
  return (
    <div>
      ...
      {proximos.length === 0 ? (
        ...
        <div key={p.id} className="anim-slide-up" style={{ background: "var(--card)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: "14px 16px", marginBottom: 10, animationDelay: `${idx * 0.1}s`, animationFillMode: "both" }}>
